...
public class ChatHistoryServiceImpl implements ChatHistoryService {
    ...
    public PageVO<ChatHistoryVO> queryChatHistory(PageQO<ChatHistoryMapperQO> pageQO) {
        ...
        PageVO<ChatHistoryVO> chatHistoryVOPageVO = PageVO.transTo(page, ChatHistoryVO.class);
        chatHistoryVOPageVO.setRecords(chatHistoryVOPageVO
                .getRecords()
                .stream()
                .sorted(Comparator.comparing(ChatHistoryVO::getGmtCreated))
                .collect(Collectors.toList()));
        return chatHistoryVOPageVO;
    }
}
